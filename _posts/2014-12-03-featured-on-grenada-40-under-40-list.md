...
A few months ago, I received an anonymous [message](https://twitter.com/lovellfelix/status/459923983723687936) on my tumblr blog about Grenada 40 project. The message didn't have much details or contact information to get in touch with the sender. I thought it was one of those Facebook "most liked" competition where you get people to vote for you or your projects. At the time, I was swamped with work, projects, and classes. I really didn't have free time to participate, so I didn't follow up with them.
...
Origin Articlce: [GRENADA’S TECH STAR: LOVELL FELIX](www.grenada40.com/40-under-40/grenada-tech-star-lovell-felix/) by Zoe Smith

> A few weeks ago, Grenada became the butt of an international joke when tech blogger, [Robin Wauters](https://twitter.com/robinwauters/status/537155962462040064), teasingly tweeted, “Could Grenada be the next Silicon Valley?”.
>
...
>
>A generation of young tech entrepreneurs is growing on the island, despite admittedly inhospitable conditions. Rather than mocking the Spice Isle, what’s needed are offers of support and credible ways to champion youth trying to forge a path in tech, as the likes of [Bevil Wooding](http://www.brightpathfoundation.org/) have done.
>
>We’re proud to feature mobile and web developer, [Lovell Felix](http://lovellfelix.com), on this year’s [40 under 40 list](http://www.grenada40.com/40-under-40-criteria/). Felix, who created the popular [Grenadian Buzz app](https://grenadianbuzz.com/),  not only illustrates what can be achieved if you commit your mind to something, his story also highlights how good employers can recognise talent in their young employees and encourage them to flourish.
>
>##The Q&A
>
...
>![The Grenadian Buzz App](/images/posts/GrenadianBuzzApp.jpg)
>**The Grenadian Buzz App**
...
>
>In addition, I decided to experiment with [Twitter](https://twitter.com/grenadianbuzz) as a form marketing, and the outreach exceeded my expectation.  Grenadian Buzz started with less than 100 users using the app daily during the first year. Now I’m seeing over 800 people using the app every day. In the past four months, the app has been downloaded a little over 1,700 times. That’s way more than I envisioned when I created the app.
>
>###When did you discover that you enjoyed tech/coding and how did you develop your skills?
>
>It started a few years ago when I was employed with [Grenada Co-operative Bank](http://www.grenadaco-opbank.com/). The bank was a great place to work. I was given many opportunities to grow professionally, and I enhanced my skills as a banker.
>
...
>
>Most of the skills I’ve acquired over the years have been obtained through resources I found on the internet. I spent numerous hours looking at YouTube videos and reading [StackOverflow](http://stackoverflow.com/users/1409209/lovell-felix) questions and answers.
>
>Additionally, I contributed to open source projects on [Github](https://github.com/lovellfelix), and followed top developers in the industry on social media networks (mainly, Twitter and Google+). Also, I’ve improved my skills by helping others. I’m a big [Zig Ziglar](http://www.ziglar.com/) fan, and recently I truly understood what he meant when he said, “You can have anything you want in life if you help enough people get what they want.”
>
>My most popular application, Grenadian Buzz, became a reality through helping a friend. One of my close friends workouts a lot in the gym and needed a way to listen to [WeeFM](http://www.weefmgrenada.com/) while doing workout routines.
>
>I thought about it for a few days then I decided to create a mobile application with WeeFm and other popular Grenadian radio stations for them to use while working out. I later submitted it to the [TEXPO](http://www.texpo.gd/) mobile application competition.
>
...
>
>There are numerous success stories from people who found their niche in tech industry. A perfect example is [Pete Cashmore](https://uk.finance.yahoo.com/news/how-pete-cashmore-made-%C2%A360-from-blogging.html). He’s the founder of [Mashable](http://mashable.com/) and had his humble beginning with his tech blog. Similarly, [Marques Brownlee](http://www.wired.com/2014/11/marques-brownlee/) started his YouTube Channel when he was 15. They both had two things in common; they enjoyed what they did and they kept at it. Now, Marques Brownlee has over two million subscribers to his [YouTube channel](https://www.youtube.com/user/marquesbrownlee) and Pete Cashmore has over 40 million monthly visitors to his blog (Mashable).
>
>This may sound like a cliché, but failure is a stepping stone to success. I’ve been there. About two years ago I started a project called “[G-VIDZ](https://plus.google.com/+G-vidz/posts)” a Grenadian video sharing web application. It was designed to help young Grenadians to showcase their talent. It failed miserably. It couldn’t compete with YouTube or the other video sharing websites.
>
...
>
>![SGU's student-led Management Information Technology/Information Technology (MISIT) Association](/images/posts/MSIT_SGU.jpg)
>**SGU’s student-led Management Information Technology/Information Technology (MISIT) Association.**
>
>I think the government and other stakeholders should encourage groups like [MISIT Students Association](https://www.facebook.com/MISITSGU) of SGU to host IT workshops and meet-ups to get to know each other, and talk about the current trends in the industry.
>
